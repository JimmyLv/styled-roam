...
var define;
var t;!function(i,s){"object"==typeof exports&&"undefined"!=typeof module?module.exports=s():"function"==typeof t&&t.amd?t(s):i.dayjs_plugin_utc=s()}(this,function(){"use strict";return function(t,i,s){var e=i.prototype;s.utc=function(t){return new i({date:t,utc:!0,args:arguments})},e.utc=function(t){var i=s(this.toDate(),{locale:this.$L,utc:!0});return t?i.add(this.utcOffset(),"minute"):i},e.local=function(){return s(this.toDate(),{locale:this.$L,utc:!1})};var f=e.parse;e.parse=function(t){t.utc&&(this.$u=!0),this.$utils().u(t.$offset)||(this.$offset=t.$offset),f.call(this,t)};var u=e.init;e.init=function(){if(this.$u){var t=this.$d;this.$y=t.getUTCFullYear(),this.$M=t.getUTCMonth(),this.$D=t.getUTCDate(),this.$W=t.getUTCDay(),this.$H=t.getUTCHours(),this.$m=t.getUTCMinutes(),this.$s=t.getUTCSeconds(),this.$ms=t.getUTCMilliseconds()}else u.call(this)};var n=e.utcOffset;e.utcOffset=function(t,i){var s=this.$utils().u;if(s(t))return this.$u?0:s(this.$offset)?n.call(this):this.$offset;var e=Math.abs(t)<=16?60*t:t,f=this;if(i)return f.$offset=e,f.$u=0===t,f;if(0!==t){var u=this.$u?this.toDate().getTimezoneOffset():-1*this.utcOffset();(f=this.local().add(e+u,"minute")).$offset=e,f.$x.$localOffset=u}else f=this.utc();return f};var o=e.format;e.format=function(t){var i=t||(this.$u?"YYYY-MM-DDTHH:mm:ss[Z]":"");return o.call(this,i)},e.valueOf=function(){var t=this.$utils().u(this.$offset)?0:this.$offset+(this.$x.$localOffset||(new Date).getTimezoneOffset());return this.$d.valueOf()-6e4*t},e.isUTC=function(){return!!this.$u},e.toISOString=function(){return this.toDate().toISOString()},e.toString=function(){return this.toDate().toUTCString()};var r=e.toDate;e.toDate=function(t){return"s"===t&&this.$offset?s(this.format("YYYY-MM-DD HH:mm:ss:SSS")).toDate():r.call(this)};var a=e.diff;e.diff=function(t,i,e){if(t&&this.$u===t.$u)return a.call(this,t,i,e);var f=this.local(),u=s(t).local();return a.call(f,u,i,e)}}});
...
},{"htm/react":"DaDa","react":"n8MK","react-dom":"NKHc","./count":"VKqU","./timings":"YWaU"}],"eqHu":[function(require,module,exports) {

},{}],"Dic7":[function(require,module,exports) {
...
},{"./utils/helper":"Dic7"}],"Mh2O":[function(require,module,exports) {
"use strict";Object.defineProperty(exports,"__esModule",{value:!0}),exports.default=y;var e=i(require("dayjs")),t=i(require("dayjs/plugin/customParseFormat")),r=i(require("dayjs/plugin/utc")),n=require("./components/render");require("./css/timings.less");var o=require("./focus"),a=require("./utils/datetime"),u=require("./utils/helper");function i(e){return e&&e.__esModule?e:{default:e}}function c(e){return f(e)||d(e)||s(e)||l()}function l(){throw new TypeError("Invalid attempt to spread non-iterable instance.\nIn order to be iterable, non-array objects must have a [Symbol.iterator]() method.")}function s(e,t){if(e){if("string"==typeof e)return m(e,t);var r=Object.prototype.toString.call(e).slice(8,-1);return"Object"===r&&e.constructor&&(r=e.constructor.name),"Map"===r||"Set"===r?Array.from(e):"Arguments"===r||/^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(r)?m(e,t):void 0}}function d(e){if("undefined"!=typeof Symbol&&Symbol.iterator in Object(e))return Array.from(e)}function f(e){if(Array.isArray(e))return m(e)}function m(e,t){(null==t||t>e.length)&&(t=e.length);for(var r=0,n=new Array(t);r<t;r++)n[r]=e[r];return n}function y(){return(0,o.addToggleMode)({id:"mode-toggle-calendar",on:"cube-add",off:"cube",styleContent:"",turnOn:function(){(0,u.switchTo)("calendar-mode"),(0,n.renderReact)(),c(document.querySelectorAll(".roam-log-page")).forEach(function(t){var r=t.querySelector("h1"),n=r&&r.textContent||"";if(console.log("currentDateStr",n),n.includes(", 2020")){var o=(0,e.default)().format("YYYY-MM-DD");console.log("currentDay",o);var u="00:00";c(t.querySelectorAll(".rm-level-0 > div.roam-block-container")).forEach(function(t){var r=t.textContent&&t.textContent.substring(0,5);if(new RegExp(/^([0-1]?[0-9]|2[0-3]):[0-5][0-9]$/).test(r))console.log("manual timestamp",r);else{var n=Number(t.querySelector("[data-create-time]").dataset.createTime);r=(0,e.default)(n).format().substring(11,16),console.log("createTime timestamp",(0,e.default)(n).format(),r)}t.setAttribute("data-timestamp",r);var i=(0,e.default)("".concat(o," ").concat(r)).diff((0,e.default)("".concat(o," ").concat(u)),"minute");console.log("duration",i),t.clientHeight;var c=(0,a.getDuration)(r);t.style.top="".concat(c,"px"),u=r})}})},turnOff:function(){(0,u.switchTo)("document-mode")}})}e.default.extend(t.default),e.default.extend(r.default);
},{"dayjs":"dZYI","dayjs/plugin/customParseFormat":"RZP1","dayjs/plugin/utc":"iObw","./components/render":"Pft5","./css/timings.less":"eqHu","./focus":"UZLb","./utils/datetime":"ykl7","./utils/helper":"Dic7"}],"XdYG":[function(require,module,exports) {
"use strict";Object.defineProperty(exports,"__esModule",{value:!0}),exports.default=i;var t=a(require("hotkeys-js")),e=a(require("tippy.js")),o=a(require("./calendar"));require("./css/card.less"),require("./css/gingko.less"),require("./css/calendar.less");var n=require("./focus"),l=require("./utils/helper");function a(t){return t&&t.__esModule?t:{default:t}}var s=localStorage.getItem("INIT_MODE")||"document";document.querySelector("html").classList.add(s);var r=function(){(0,l.switchTo)("card-mode"),document.querySelector(".zoom-path-view.rm-zoom")&&document.querySelector(".zoom-path-view.rm-zoom").firstChild.click()};(0,l.appendIcon)("cardList",r),(0,l.appendIcon)("cardFlow",function(){(0,l.switchTo)("flow-mode")}),(0,l.appendIcon)("document",function(){(0,l.switchTo)("document-mode")});var u=(0,n.addToggleMode)({id:"mode-toggle-focus",on:"eye-on",off:"eye-open",styleContent:"\n\t.roam-block-container div[id]{\n  \t\topacity: 0.2;\n    }\n\t.roam-block-container div[id]:hover{\n \t \topacity: 1;\n\t}\n  .roam-toolkit-block-mode--highlight {\n    opacity: 1 !important;\n  }\n"}),d=(0,o.default)();function i(){(0,t.default)("alt+shift+1",function(t,e){t.preventDefault(),r()}),(0,t.default)("alt+shift+2",function(t,e){t.preventDefault(),(0,l.switchTo)("flow-mode")}),(0,t.default)("alt+shift+3",function(t,e){t.preventDefault(),(0,l.switchTo)("document-mode")}),(0,t.default)("alt+shift+4",function(t,e){t.preventDefault(),u()}),(0,t.default)("alt+shift+f",function(t,e){t.preventDefault(),u()}),(0,t.default)("alt+shift+5",function(t,e){t.preventDefault(),d()}),(0,t.default)("alt+shift+c",function(t,e){t.preventDefault(),d()}),(0,e.default)("#mode-button-cardList",{content:'Card List<sup>mode</sup> <span style="font-size:7pt">(Alt-Shift-1)</span>',allowHTML:!0,theme:"light-border"}),(0,e.default)("#mode-button-cardFlow",{content:'Card Flow<sup>mode</sup> <span style="font-size:7pt">(Alt-Shift-2)</span>',allowHTML:!0,theme:"light-border"}),(0,e.default)("#mode-button-document",{content:'Outliner<sup>mode</sup> <span style="font-size:7pt">(Alt-Shift-3)</span>',allowHTML:!0,theme:"light-border"}),(0,e.default)("#mode-toggle-focus",{content:'Focus<sup>mode</sup> <span style="font-size:7pt">(Alt-Shift-4/f)</span>',allowHTML:!0,theme:"light-border"}),(0,e.default)("#mode-toggle-calendar",{content:'Calendar<sup>mode</sup> <span style="font-size:7pt">(Alt-Shift-5/c)</span>',allowHTML:!0,theme:"light-border"}),console.log("started styled-roam")}
